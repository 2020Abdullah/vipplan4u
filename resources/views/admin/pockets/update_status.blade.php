...
@section('content')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <!-- content -->
            <form action="{{ route('pocket.update_status',['id' =>$pocket->id])   }}" method="POST" enctype="multipart/form-data">
                @csrf
                                      {{-- {{ csrf_field() }} --}}

                <input type="hidden" value="{{ $pocket->id }}" name="pocket_id">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for=""> total_deposited_amount name</label>
                            <input type="text" class="form-control" name="total_deposited_amount"
                                value="{{ $pocket->total_deposited_amount }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="payment_method_id"
                                value="{{ $pocket->payment_method_id }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="package_id" value="{{ $pocket->package_id }}" readonly>
                        </div>
                    </div>
