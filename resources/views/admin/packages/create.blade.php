          ...
          <div class="row">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="card_min">
                  </div>
              </div>
              <div class="col-md-6">
                  <div class="form-group">
                      <label for="">الحد الأقصي للخطة</label>
                      <input type="text" class="form-control" name="card_mix">
                  </div>
              </div>
              <div class="col-md-3">
                  <div class="form-group">
                      ...
                      <div class="d-flex">
                        <input type="text" class="form-control" name="card_Rate">
                        <input type="text" class="form-control" value="%" style="width: 30%" readonly>
                      </div>
                  </div>
              </div>
              <div class="col-md-3">
              ...
              <div class="col-md-3">
                  <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="card_earn_num">
                  </div>
              </div>
          </div>
          <div class="form-group">
