        ...
        <div class="col-md-12">
            ...
            <div class="form-row">
                ...
                <div class="container pay-ways-box active-form p-5 w-100"
                    style="background:#fff6f6ad;padding: 40px; border-radius: 40px;margin-bottom: 40px;">
                    <!-- Start of the title -->
                        ...
                        <div id="firstStep" class="step first-step w-100 position-relative">
                            <div class="row m-0">
                                ...
                                <div class="col-lg-10 pay-ways p-0 d-flex align-items-center flex-wrap mb-3 ">
                                    ...
                                    @forelse ($payment_methods as $payment_method)
                                        <div class="col-md-3 pay-way">
                                            {{-- <input type="hidden" wire:key="payment_method" value="{{$payment_method->id}}" /> --}}
                                            <input type="radio" name="payment_method_id"
                                                value={{ $payment_method->id }} wire:model="payment_method_id"
                                                data-percent="20" data-fixed="0" data-min_deposit="5"
                                                data-max_deposit="4006" id="payment_type_1_{{ $payment_method->id }}"
                                                class="payment_method d-none">
                                            <label for="payment_type_1_{{ $payment_method->id }}"
                                                class="d-flex align-items-center p-2 mb-3 border border-2 ">
                                                <!-- Pay way img -->
                                                <img
                                    ...
                                    @empty
                                        <div class="text-center">
                                            <td colspan="10">لا توجد وسيلة دفع مضافة أو مفعلة بعد</td>
                                        </div>
                                    @endforelse
                                </div>
                            ...
                            <div class="amount row p-0 mx-0 align-items-center mb-4">
                                ...
                                <div class="col row no-gutters">
                                    <div class="col-md-6">
                                        <!-- Amount input -->
                                        <input type="number" style="direction: rtl" min="1"
                                            wire:model="price" id="amountInput"
                                 ...
                                 <div class="col row no-gutters">
                                    <div class="col-md-6">
                                        <!-- Amount input -->
                                        {{-- <input type="hidden" style="direction: rtl" min="1" 
                                            value="tags" name="name" id="pocket"
                                            class="pocket form-control fs-5" > --}}
                                    </div>
                                    @error('total_deposited_amount')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="d-flex align-items-center justify-content-end">
                                ...
                                <button id="secondStepBtn" type="button"
                                    class="btn btn-primary fs-5 lh-lg fw-bold p-1 px-5" wire:click="firstStepSubmit54">
                                    التالي »
                                </button>
