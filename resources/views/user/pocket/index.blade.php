            ...
            <div class="row">
                <div class="col-xl-8 cols-12">
                    ...
                    <div class="w-100 mx-auto actions d-flex align-items-center mb-4 overflow-hidden ">
                        ...
                        <a href="{{route('pocket.create')}}"  class="action mb-0 p-3 ms-3">
                        ...
                        <a href="https://tftwallet.com/ar/user/withdraw/create" class="action mb-0 p-3 ms-3">
            ...
            لا يوجد بيانات لعرضها
                ...
                <div class="col-xl-4 cols-12">
                    ...
                    <div class="wallet mb-3">
                        <div class="ecard">
                            <img class="icon" src="https://tftwallet.com/user/images/favicon.png" alt="">
                            <div class="details">
                                <span class="card-title d-block">الرصيد المتاح</span>
                                <div class="balance">$0.000</div>
                            </div>
                            <span class="card-name">Mohamed Ali</span>
                        </div>
                    </div>
                    <!-- End of the funds -->
